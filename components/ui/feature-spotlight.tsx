  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-[320px] shrink-0 flex-col items-center text-center md:w-[240px] md:items-start md:text-left lg:w-[280px] lg:pt-4">
        ...
        >
          Where architecture meets the natural world.
        </p>
      ...
      >
        ...
        <div className="relative h-[280px] w-[260px] overflow-hidden sm:h-[320px] sm:w-[300px] md:h-[360px] md:w-[320px] lg:h-[420px] lg:w-[380px]">
          ...
          <div className="absolute left-2 top-2 md:left-3 md:top-3">
            <div
              className="absolute h-5 w-px bg-white/80 transition-all duration-500 md:h-6"
              style={{ opacity: isHovered ? 1 : 0, transform: isHovered ? "scaleY(1)" : "scaleY(0)", transformOrigin: "top", transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)", transitionDelay: "50ms" }}
            />
            <div
              className="absolute h-px w-5 bg-white/80 transition-all duration-500 md:w-6"
              style={{ opacity: isHovered ? 1 : 0, transform: isHovered ? "scaleX(1)" : "scaleX(0)", transformOrigin: "left", transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)", transitionDelay: "100ms" }}
            />
          </div>
          <div className="absolute bottom-2 right-2 md:bottom-3 md:right-3">
            <div
              className="absolute h-5 w-px bg-white/80 transition-all duration-500 md:h-6"
              style={{ opacity: isHovered ? 1 : 0, transform: isHovered ? "scaleY(1)" : "scaleY(0)", transformOrigin: "bottom", transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)", transitionDelay: "150ms" }}
            />
            <div
              className="absolute h-px w-5 bg-white/80 transition-all duration-500 md:w-6"
              style={{ opacity: isHovered ? 1 : 0, transform: isHovered ? "scaleX(1)" : "scaleX(0)", transformOrigin: "right", transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)", transitionDelay: "200ms" }}
            />
          </div>
        </div>
